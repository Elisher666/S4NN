...
//#define TEST_LOG_PRINT_SIM 0
//#define TEST_LOG_PRINT_SIM_LAST 1
...
//top level
#define NUM_TOTAL_CLUSTER 5
#define NUM_PE_PER_CLUSTER 1
#define MASK_CLST_INIT_FLAG 0b0000011111
#define TIMESTEP_START_POINT 1
#define CLST_ID_WIDTH 3


//ddr related  weight
//#define BASE_ADDR_DDR 0x00007FFA36FF
...
//#define _spike_mem ap_uint<WIDTH_SPIKE_MEM>
#define _input_mem ap_uint<WIDTH_INPUT_MEM>
...
//#define _idx_input_mem ap_uint<WIDTH_INPUT_MEM_IDX>
...
struct sClstInputPkg{
	//_potential_mem PotenMemPE[NUM_PE_PER_CLUSTER][DEPTH_POTENTIAL_MEM];
	//_weight_mem WeightMemPE[NUM_PE_PER_CLUSTER][DEPTH_WEIGHT_MEM];
	_instr_mem InstrMem[DEPTH_INSTR_MEM];
	//_idx_input_mem IdxInputMem[1];
...
#define OR    0b00011
#define XOR   0b00100
#define LFT   0b00101     //5
#define RFT   0b00110
#define SGS   0b00111      //7
#define CCT   0b01000       //8
#define ADD   0b01001     //9
#define SUB   0b01010
#define MUL   0b01011   //11
#define DVD   0b01100
#define MOD   0b01101
#define JE    0b01110
#define JG    0b01111
#define JL    0b10000
#define JMP   0b10001          //17
#define RDI   0b10010       //18
#define LDW   0b10011      //19
#define WDW   0b10100
#define RWM   0b10101      //21
#define RPM   0b10110      //22
#define WBW   0b10111
#define WBP   0b11000       //24
#define OPT   0b11001      //25
#define SYN   0b11110
#define DONE  0b11111
